...
Val_pred_GBM <- predict(mod_GBM, newdata = Validation_Data.PCA)
Val_pred_RF <- predict(mod_RF, newdata = Validation_Data.PCA)
...
* The known best performer __`Random Forest`__ performs better than other methods like `GBM & rPART` with an out of sample accuracy of __`70%`__
